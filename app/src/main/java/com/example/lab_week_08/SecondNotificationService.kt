...
class SecondNotificationService : Service() {
    ...
    override fun onCreate() {
        ...
        //in the startForegroundService() custom function notificationBuilder = startForegroundService()
    ...
    private fun startForegroundService(): NotificationCompat.Builder {
        ...
        //into a Second notification builder
        //Remember that getNotificationBuilder() is not a built-in function!
        val secondNotificationBuilder = getNotificationBuilder(
        ...
        startForeground(NOTIFICATION_ID, secondNotificationBuilder.build())
        return secondNotificationBuilder
    }
